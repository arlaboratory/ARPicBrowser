...
extern NSString *const AsyncUIImageLoadDidFinish;
extern NSString *const AsyncUIImageLoadDidFail;

extern NSString *const AsyncUIImageImageKey;
extern NSString *const AsyncUIImageURLKey;
extern NSString *const AsyncUIImageCacheKey;
extern NSString *const AsyncUIImageErrorKey;


@interface AsyncUIImageCache : NSObject
...
@interface AsyncUIImageLoader : NSObject
...
@interface UIImageView(AsyncUIImageView)
